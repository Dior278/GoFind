...
/**
 * REST controller for managing {@link com.gofing.myapp.domain.Utilisateur}.
 */
@RestController
...
public class UtilisateurResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<UtilisateurDTO>> createUtilisateur(@RequestBody UtilisateurDTO utilisateurDTO) throws URISyntaxException {
