package com.gofing.myapp.config;

import static com.gofing.myapp.security.SecurityUtils.AUTHORITIES_KEY;
import static com.gofing.myapp.security.SecurityUtils.JWT_ALGORITHM;

import com.gofing.myapp.management.SecurityMetersService;
