...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OBJETVOLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OBJETVOLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OBJETVOLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OBJETVOLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OBJETVOLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OBJETVOLE actions', async () => {
      const arg = 42666;
