...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIECEALOUER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PIECEALOUER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PIECEALOUER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PIECEALOUER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PIECEALOUER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PIECEALOUER actions', async () => {
      const arg = 42666;
