...
export const ApplicationUserUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    if (values.additionalField !== undefined && typeof values.additionalField !== 'number') {
      values.additionalField = Number(values.additionalField);
    }
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="goFindApp.applicationUser.home.createOrEditLabel" data-cy="ApplicationUserCreateUpdateHeading">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                id="application-user-additionalField"
                name="additionalField"
                data-cy="additionalField"
                type="text"
                validate={{
                  min: { value: 42, message: 'This field should be at least 42.' },
                  max: { value: 42, message: 'This field cannot be more than 42.' },
